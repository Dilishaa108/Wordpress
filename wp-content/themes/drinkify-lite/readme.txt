...
= 2.3 (Released: February 18, 2026) =
* Bug Fixed: Product bg color issue
* Bug Fixed: Header editor issue
* Bug Fixed: Spacing issue in patterns
* Updated: Patterns having navigation block
* Updated: Minor WooCommerce CSS
* Updated: Header template part for all templates

= 2.2 (Released: January 23, 2026) =
* Added: New product collection template part
* Added: Required 'product-sidebar' template part and pattern
* Bug Fixed: Viewport animation issue
* Bug Fixed: Frontpage header editor issue
* Updated: All product template part
...
* Bug Fixed: text-domain issue in Header Media
* Updated: WordPress 6.9 ready

= 2.1 (Released: July 22, 2025) =
* Added: Bluesky, Threads, Tiktok & X.com icons
* Bug Fixed: Header Media text huge gap on editor
* Bug Fixed: Removed duplicate search form from 404 page
* Bug Fixed: Header width increased to add more space for nav item
* Updated: Cart, Checkout page refined
* Updated: Footer newsletter subscription replaced with contact section
* Updated: Refined Best Seller/Latest Products Pattern product scroller
* Updated: Header customer account icon changed

= 2.0 (Released: May 19, 2025) =
* Bug Fixed: Header Cart, Search, Account icon size fixings
* Bug Fixed: Banner Text spacing issue fixed on Editor

= 1.2.3 (Released: April 30, 2025) =
* Added: Order confirmation page and updated design
* Updated: Design fixed on featured category and product
...
Drinkify Lite WordPress Theme, 2012-2026 Catchthemes.com
Drinkify Lite is distributed under the terms of the GNU GPL.

Drinkify Lite is based on Catch FSE WordPress Theme, 2012-2025 Catchthemes.com
