...
/**
 * Title: Recent Blog
 * Slug: drinkify-lite/recent-blog
 * Categories: drinkify-lite, query
 */
?>
		...
		<div class="wp-block-column" style="flex-basis:26.8%">
			...
			<div class="wp-block-group wp-block-widget-area wp-block-sidebar">
				...
				<div class="wp-block-group wp-block-widget about">
					...
					<h2 id="about" style="margin-top:0px;margin-right:0px;margin-bottom:20px;margin-left:0px"><?php esc_html_e('About', 'drinkify-lite'); ?></h2>
					<!-- /wp:heading -->
            ...
            commodo, rhoncus et ante.', 'drinkify-lite'); ?></p>
					<!-- /wp:paragraph -->
					<!-- wp:buttons -->
				...
				<div class="wp-block-group wp-block-widget">
					<!-- wp:heading {"style":{"spacing":{"margin":{"top":"0px","right":"0px","bottom":"20px","left":"0px"}}}} -->
					<h2 id="categories" style="margin-top:0px;margin-right:0px;margin-bottom:20px;margin-left:0px"><?php esc_html_e('Categories', 'drinkify-lite'); ?></h2>
					<!-- /wp:heading -->
					<!-- wp:categories /-->
				</div>
				<!-- /wp:group -->
