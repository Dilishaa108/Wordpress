		...
		<div class="wp-block-group">
			...
			<div class="wp-block-columns alignwide are-vertically-aligned-center header-media-content">
				...
				<div class="wp-block-column is-vertically-aligned-center media-content">
					...
					<!-- /wp:paragraph -->
					<!-- wp:heading {"textAlign":"left","fontSize":"huge-display","textColor":"dark-color"} -->
					<h2 class="wp-block-heading has-text-align-left has-dark-color-color has-huge-display-font-size">
